...
export function PostScheduleTable({
  ...
  const sortedBase = useMemo(() => {
    return [...orderedRows].sort((a, b) => {
      ...
      // Primary sort: most recent "Date Posted" first. Rows without a
      // go-live date fall to the end of their group, ordered by manual
      // drag position (sort_order) — which is also the tie-breaker for
      // rows that share the same go-live date.
